...
public class CallbackSupport {
	...
	public void bindRemoteServiceAdmin(RemoteServiceAdmin rsa) {
		this.rsa = rsa;
	}

	public void unbindRemoteServiceAdmin(RemoteServiceAdmin rsa) {
		this.rsa = null;
	}
	...
	private Class<?> findInterface(List<String> intfNames,Class<?> clazz) {
