 ...
 * @since 3.3
 */
public class RemoteBundleManagerAdapterFactory implements IAdapterFactory {

	private RemoteBundleManagerWorkbenchAdapter bundleRootAdapter = new RemoteBundleManagerWorkbenchAdapter();
	...
	protected Object getWorkbenchElement(Object adaptableObject) {
		if (adaptableObject instanceof RemoteBundleManagerNode)
			return bundleRootAdapter;
		return null;
	}
